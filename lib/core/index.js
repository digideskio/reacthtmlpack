...
exports.srcFileToAbsolutePath = srcFileToAbsolutePath;
...
function srcFileToAbsolutePath(__srcFile__) {
  return __srcFile__.map(function (srcFile) {
    return (0, _path.resolve)(process.cwd(), srcFile);
  });
}
...
function transformRelativePathForModule(moduleName, text, moduleExcludeList) {
  var extname = (0, _path.extname)(moduleName);
  switch (extname) {
    case ".js":
      return (0, _transformRelativePath2.default)(text, moduleExcludeList);
    default:
      {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _fs2.default.readFile(srcFile, "utf8");
            ...
            case 3:
              ...
              moduleExcludeList = moduleList.map(function (_ref4) {
                ...
                switch (extname) {
                  case ".js":
                    return moduleName.replace(extname, "");
                  default:
                    {
              ...
              _clientEntryList$redu = clientEntryList.reduce(function (acc, _ref6) {
                ...
                return {
                  ...
                  clientWriteFilePromiseList: [].concat((0, _toConsumableArray3.default)(acc.clientWriteFilePromiseList), [_fs2.default.writeFile(clientFilepath, code, "utf8")])
                };
              ...
              _serverEntryList$redu = serverEntryList.reduce(function (acc, _ref7) {
                ...
                return {
                  ...
                  serverWriteFilePromiseList: [].concat((0, _toConsumableArray3.default)(acc.serverWriteFilePromiseList), [_fs2.default.writeFile(serverFilepath, code, "utf8")])
                };
              ...
              moduleWriteFilePromiseList = moduleList.reduce(function (acc, _ref5) {
                ...
                var clientFilepath = (0, _path.resolve)(clientWorkspacePath, moduleName);
                var serverFilepath = (0, _path.resolve)(serverWorkspacePath, moduleName);
                debugCore({ clientFilepath: clientFilepath, serverFilepath: serverFilepath });

                var code = transformRelativePathForModule(moduleName, text, moduleExcludeList);
...
function sourceToServerWebpackConfig(__source__) {
  return __source__.map(function (_ref11) {
    ...
    return console.log(customServerConfig) || (0, _createWebpackConfig.createServerWebpackConfig)(customServerConfig);
  });
}
